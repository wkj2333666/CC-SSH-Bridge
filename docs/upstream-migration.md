...
| 7 | Native helper search and cancellation-safe concurrent session leasing | In progress — 7A nested basename glob semantics complete (CI 31653184871; cross-architecture 31652940665); 7B exhaustive search beyond the bounded candidate prefix in progress |
