...
| 3 | Remote binary helper fast path and complete cross-architecture CI packaging | In progress — 3E persistent helper install/reuse and mode reporting (CI pending) |
