...
| 6 | Write-back edit cache, synchronization barriers, poisoned-session recovery, and one setup deadline | In progress — 6A write-back cache configuration contract complete (CI 31644038846; cross-architecture 31644038789); 6B in-memory edit cache state machine pending |
