...
| 8 | Durable remote job lifecycle and MCP tools | In progress — 8A closed job protocol contract complete (CI 31657983208; cross-architecture 31657983206); 8B durable job runner in progress |
