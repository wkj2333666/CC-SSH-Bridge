...
| 6 | Write-back edit cache, synchronization barriers, poisoned-session recovery, and one setup deadline | In progress — 6A write-back cache configuration contract in progress |
