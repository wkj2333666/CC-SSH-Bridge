...
| 10 | Full source, behavior, documentation, packaging, CI, and release parity audit against the pinned upstream snapshot | In progress — edit-cache recovery tools and Claude launcher-entry preservation implemented; CI pending |
