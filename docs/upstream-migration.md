...
| 5 | Compact MCP results, bounded session liveness, output/RSS controls, and cache policy | In progress — 5A explicit remote helper timeout reporting in progress |
