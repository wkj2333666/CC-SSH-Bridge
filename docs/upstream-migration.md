...
| 10 | Full source, behavior, documentation, packaging, CI, and release parity audit against the pinned upstream snapshot | In progress — edit-cache recovery tools, Claude launcher-entry preservation, v0.8.1 metadata, and complete installable release archives implemented; CI and release pending |
